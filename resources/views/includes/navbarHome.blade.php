...
<div class="container" style="margin-top: -10px;">
        ...
        <div class="navbar-nav ml-auto">
            ...
            @if (Auth::check())
                <a class="nav-item btn btn-primary tombol" href="{{ route('dashboard') }}">Dashboard</a>
            @else
                <a class="nav-item btn btn-primary tombol {{ (\Request::route()->getName() == 'login') ? 'active' : ''}}" href="{{ route('login') }}">Login</a>
